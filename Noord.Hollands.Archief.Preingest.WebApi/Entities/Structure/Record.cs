...
{
    [Serializable()]
    public class Record : Sidecar
    {
        public Record(String name, String path, Dossier parent) : base(name, path, parent) { }
        public override bool CompareAggregationLevel
        {
            get
            {
                ...
                result = (aggregatieTypeObject.aggregatieniveau.Value == aggregatieAggregatieniveauType.Record);
        ...
        {
            return String.Format("{0} (Record)", this.Name);
        }
